...
iptables -t nat -A POSTROUTING -o enp0s3 -s 10.10.10.0/24 -j MASQUERADE
...
# Redireciona portas
iptables -A FORWARD -i enp0s8 -d 10.10.10.1/24 -j ACCEPT
iptables -A FORWARD -i enp0s9 -d 10.10.10.1/24 -j ACCEPT
