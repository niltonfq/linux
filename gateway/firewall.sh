...
iptables -A FORWARD -p tcp -s $EXT -d $STG --dport 443 -j ACCEPT
...
iptables -t nat -A PREROUTING -p tcp -i enp0s9 -s $EXT -d $FWL1 --dport 443 -j DNAT --to-destination $STG:443
